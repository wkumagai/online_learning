...
class DatasetManager:
    ...
    def __init__(self, base_path: str = None):
        ...
        Args:
            base_path: Base path for datasets. If None, uses default path
        """
        if base_path is None:
            base_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data/datasets")
